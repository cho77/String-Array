<?php
 ...
 $array1=array( "apple", "watermelon","grapes");
$games = array("d" => "cricket", "a" => "tennis", "b" => "basketball", "c" => "football");
  ...
  class main {
    ...
    echo str_word_count($text2);
      ...
      $onlyconsonants = str_replace($vowels, "V", "Hello World");
      echo $onlyconsonants;
      echo '<hr>';
    }
...
$rest = substr($text, -1);   
 ...
 array_push($array1, "apple", "blackberry");
print_r($array1);
            echo '<hr>';
}
...
print_r($games);
    ...
    array_unshift($array1, "apple", "blackberry");
print_r($array1);
      echo '<hr>';
}
